      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center text-center mb-16 sm:mb-20">
          ...
          <h2 className="font-heading font-extrabold text-3xl sm:text-5xl text-slate-900 dark:text-white tracking-tight">
            Flagship <span className="bg-gradient-to-r from-indigo-600 via-sky-600 to-cyan-600 dark:from-indigo-400 dark:via-sky-300 dark:to-cyan-300 bg-clip-text text-transparent">Hardware &amp; Systems</span>
          </h2>
          <p className="mt-4 text-base sm:text-lg text-slate-600 dark:text-slate-300 max-w-2xl font-normal leading-relaxed">
            Real-world systems engineered with synthesizable Verilog RTL, waveform-level verification, and autonomous edge robotics.
          </p>
        </div>
