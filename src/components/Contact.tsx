...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-20 sm:py-32 bg-[#060912] overflow-hidden">
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center text-center mb-16 sm:mb-20">
          ...
          <h2 className="font-heading font-extrabold text-3xl sm:text-5xl text-white tracking-tight">
            Let&apos;s Build the Future of <span className="bg-gradient-to-r from-indigo-400 via-sky-300 to-cyan-300 bg-clip-text text-transparent">Hardware</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="rounded-3xl glass-panel p-6 sm:p-8 border border-white/[0.08] shadow-xl glass-panel-hover">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-3 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-400">
                  <Mail className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="font-heading font-bold text-lg text-white">Direct Email</h3>
            ...
            <div className="rounded-3xl glass-panel p-6 sm:p-8 border border-white/[0.08] shadow-xl glass-panel-hover space-y-4">
              ...
              <a
                ...
                className="flex items-center justify-between p-3.5 rounded-2xl bg-white/[0.03] hover:bg-white/[0.08] border border-white/[0.06] hover:border-indigo-400/40 transition group"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] text-slate-400 font-mono">github.com/satya-eesa</span>
                  </div>
                </div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-between p-3.5 rounded-2xl bg-white/[0.03] hover:bg-white/[0.08] border border-white/[0.06] hover:border-cyan-400/40 transition group"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-xs font-semibold text-white block">LinkedIn Network</span>
                    <span className="text-[11px] text-slate-400 font-mono">linkedin.com/in/satya-eesa</span>
                  </div>
                </div>
          ...
          <div className="lg:col-span-7">
            <div className="rounded-3xl glass-panel p-6 sm:p-10 border border-white/[0.08] shadow-xl glass-panel-hover">
              <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/[0.08]">
                <div className="p-2.5 rounded-xl bg-cyan-500/10 border border-cyan-500/20 text-cyan-400">
                  <MessageSquare className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="font-heading font-bold text-xl text-white">Send a Message</h3>
                  <p className="text-xs text-slate-400">Inquire about internships, hardware projects, or collaborations</p>
                </div>
              </div>

              {sentSuccess ? (
                <div className="p-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-center animate-in fade-in duration-300">
                  ...
                  <h4 className="font-heading font-bold text-lg text-white mb-1">Message Transmitted!</h4>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-white/[0.03] border border-white/[0.08] focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm text-white placeholder-slate-500 transition"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white/[0.03] border border-white/[0.08] focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm text-white placeholder-slate-500 transition resize-none"
                    />
                  </div>
